...
@RestController
@RequestMapping("/api/slimademo-kafka")
public class SlimademoKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SlimademoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SlimademoKafkaResource(KafkaProperties kafkaProperties) {
